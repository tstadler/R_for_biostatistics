...
```
If you want to change the axis label formatting to non-scientific notation you can use the library *scales* and
```{r, eval=FALSE}
...
Now, compute group means and standard deviations for all combinations of moon phase and season. Plot a point plot with s.d. error bars which shows how hospital admissions vary as a function of season (x-axis) and moon phase. 
